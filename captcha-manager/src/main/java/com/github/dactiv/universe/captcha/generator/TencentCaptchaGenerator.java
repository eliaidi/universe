...
public class TencentCaptchaGenerator extends AbstractJpegImgCaptchaGenerator{
    ...
    public String generate(CaptchaToken token) throws CaptchaException {
        ...
        String code = generateCaptcha(jpegImgCaptchaToken.getLength());
        outputImage(jpegImgCaptchaToken.getWidth(), jpegImgCaptchaToken.getHeight(), token.getOutputStream(), code);
        return code;
    }
